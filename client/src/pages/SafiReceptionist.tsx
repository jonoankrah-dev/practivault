...
import { Mic, MicOff, Loader2, Volume2, Trash2, ArrowLeft } from "lucide-react";
...
// ── Component ─────────────────────────────────────────────────────────────────
export default function SafiReceptionist({ onBack }: { onBack?: () => void }) {
    ...
    <div className="flex flex-col h-full max-h-screen">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b bg-background">
        <div className="flex items-center gap-3">
          {onBack && (
            <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => { disconnect(); onBack(); }}>
