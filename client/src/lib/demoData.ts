...
interface DemoQuoteItem { item: string; qty: number; unitPrice: number }
interface DemoQuote { clientName: string; description: string; amount: number; status: string; items: DemoQuoteItem[] }
  ...
  aesthetics: {
    ...
    quotes: [
      { clientName: "Jade Thornton",  description: "endoPulse Laser x6 Course", amount: 2400, status: "sent",
        items: [
          { item: "endoPulse Laser Session x6", qty: 6, unitPrice: 330 },
          { item: "Skin Consultation",          qty: 1, unitPrice: 75 },
          { item: "Aftercare Kit",              qty: 1, unitPrice: 45 },
          { item: "VAT (20%)",                  qty: 1, unitPrice: 150 },
        ]},
      { clientName: "Melissa Frost",  description: "Reactivation Package (3 treatments)", amount: 480, status: "draft",
        items: [
          { item: "Hydrafacial",          qty: 1, unitPrice: 150 },
          { item: "Chemical Peel",        qty: 1, unitPrice: 120 },
          { item: "Microneedling",        qty: 1, unitPrice: 160 },
          { item: "Skincare Travel Pack", qty: 1, unitPrice: 50 },
        ]},
      { clientName: "Hannah Clarke",  description: "Consultation + Botox", amount: 470, status: "viewed",
        items: [
          { item: "Initial Consultation",      qty: 1, unitPrice: 50 },
          { item: "Botox — Forehead & Frown",  qty: 1, unitPrice: 280 },
          { item: "Lip Filler 0.5ml",          qty: 1, unitPrice: 110 },
          { item: "Review Appointment",        qty: 1, unitPrice: 30 },
        ]},
    ],
    consent: [
  ...
  hair: {
    ...
    quotes: [
      { clientName: "Isla Ferguson",  description: "Bridal Hair Package (6 people)", amount: 680, status: "sent",
        items: [
          { item: "Bridal Hair Up-do",       qty: 1, unitPrice: 120 },
          { item: "Bridesmaid Blow Dry",     qty: 5, unitPrice: 55 },
          { item: "On-site travel surcharge",qty: 1, unitPrice: 35 },
          { item: "Floral Hair Accessories", qty: 6, unitPrice: 8 },
        ]},
      { clientName: "Amy Patel",      description: "Full Transformation Package", amount: 320, status: "viewed",
        items: [
          { item: "Full Colour (Balayage)",  qty: 1, unitPrice: 145 },
          { item: "Cut & Blow Dry",          qty: 1, unitPrice: 55 },
          { item: "Keratin Treatment",       qty: 1, unitPrice: 95 },
          { item: "Olaplex Treatment",       qty: 1, unitPrice: 25 },
        ]},
      { clientName: "Megan Taylor",   description: "Win-back Colour Deal", amount: 89, status: "draft",
        items: [
          { item: "Root Touch-up Colour", qty: 1, unitPrice: 65 },
          { item: "Blow Dry",             qty: 1, unitPrice: 24 },
        ]},
    ],
    consent: [
  ...
  plumber: {
    ...
    quotes: [
      { clientName: "Raj Patel",   description: "Full Bathroom Refit inc. tiling", amount: 2800, status: "sent",
        items: [
          { item: "Labour — Bathroom Strip & Fit", qty: 1, unitPrice: 1200 },
          { item: "Materials — Sanitaryware",      qty: 1, unitPrice: 850 },
          { item: "Tiling — Floor & Walls",        qty: 1, unitPrice: 480 },
          { item: "Plumbing Connections",          qty: 1, unitPrice: 190 },
          { item: "VAT (20%)",                     qty: 1, unitPrice: 80 },
        ]},
      { clientName: "Colin Marsh", description: "Underfloor Heating — Extension", amount: 3200, status: "viewed",
        items: [
          { item: "Labour — Install & Commission", qty: 1, unitPrice: 950 },
          { item: "UFH Manifold & Pipe Kit",       qty: 1, unitPrice: 780 },
          { item: "Screed & Board",                qty: 1, unitPrice: 620 },
          { item: "Thermostat & Wiring",           qty: 1, unitPrice: 290 },
          { item: "VAT (20%)",                     qty: 1, unitPrice: 560 },
        ]},
      { clientName: "Anita Roy",   description: "Boiler Replacement (Combi)", amount: 2200, status: "draft",
        items: [
          { item: "Labour — Remove & Fit",         qty: 1, unitPrice: 450 },
          { item: "Worcester Bosch 30i Combi",     qty: 1, unitPrice: 1100 },
          { item: "Flue & Fittings",               qty: 1, unitPrice: 180 },
          { item: "Magnetic Filter",               qty: 1, unitPrice: 120 },
          { item: "Gas Safe Certification",        qty: 1, unitPrice: 80 },
          { item: "VAT (20%)",                     qty: 1, unitPrice: 270 },
        ]},
    ],
    consent: [
  ...
  electrician: {
    ...
    quotes: [
      { clientName: "Gina Torres",  description: "Solar Panels 12kW + Battery Storage", amount: 9800, status: "sent",
        items: [
          { item: "Labour — Install & Commission",  qty: 1, unitPrice: 1800 },
          { item: "Solar Panels 400W",              qty: 12, unitPrice: 280 },
          { item: "Inverter (Growatt 10kW)",        qty: 1, unitPrice: 1400 },
          { item: "Battery Storage 10kWh",          qty: 1, unitPrice: 3000 },
          { item: "Scaffolding",                    qty: 1, unitPrice: 450 },
          { item: "DNO Application & Grid Tie",     qty: 1, unitPrice: 750 },
          { item: "VAT (0% — energy saving)",       qty: 1, unitPrice: 0 },
        ]},
      { clientName: "Owen Drake",   description: "Solar Panels 8kW + Battery", amount: 7200, status: "viewed",
        items: [
          { item: "Labour — Install & Commission",  qty: 1, unitPrice: 1400 },
          { item: "Solar Panels 400W",              qty: 8, unitPrice: 280 },
          { item: "Inverter (Solis 8kW)",           qty: 1, unitPrice: 1100 },
          { item: "Battery Storage 7.5kWh",         qty: 1, unitPrice: 2200 },
          { item: "Scaffolding",                    qty: 1, unitPrice: 380 },
          { item: "DNO Application",                qty: 1, unitPrice: 480 },
        ]},
      { clientName: "Paula Shaw",   description: "Full Rewire 3-bed + EICR", amount: 3400, status: "draft",
        items: [
          { item: "Labour — Full Rewire (3-bed)",   qty: 1, unitPrice: 2200 },
          { item: "Consumer Unit 18-way",           qty: 1, unitPrice: 380 },
          { item: "Cable & Materials",              qty: 1, unitPrice: 520 },
          { item: "EICR Certificate",               qty: 1, unitPrice: 150 },
          { item: "VAT (20%)",                      qty: 1, unitPrice: 150 },
        ]},
    ],
    consent: [
  ...
  joiner: {
    ...
    quotes: [
      { clientName: "Ben Whitaker",  description: "Loft Conversion Joinery Package", amount: 3500, status: "sent",
        items: [
          { item: "Labour — Stud Walls & Ceiling", qty: 1, unitPrice: 1200 },
          { item: "Roof Window (Velux GGL)",       qty: 2, unitPrice: 650 },
          { item: "Staircase — Straight Rise",     qty: 1, unitPrice: 950 },
          { item: "Timber & Sheet Materials",      qty: 1, unitPrice: 480 },
          { item: "Door & Frame",                  qty: 1, unitPrice: 220 },
        ]},
      { clientName: "Ruth Dawson",   description: "Garden Office — Doors & Windows", amount: 2800, status: "viewed",
        items: [
          { item: "Labour — Hang & Fit",            qty: 1, unitPrice: 800 },
          { item: "Bi-fold Doors (3-panel)",        qty: 1, unitPrice: 1200 },
          { item: "Fixed Window (double glazed)",   qty: 2, unitPrice: 280 },
          { item: "Door Handle & Lock Set",         qty: 1, unitPrice: 95 },
          { item: "Draught-proofing & Seals",       qty: 1, unitPrice: 145 },
        ]},
      { clientName: "Tom Healy",     description: "Fitted Kitchen Supply & Fit", amount: 6200, status: "draft",
        items: [
          { item: "Labour — Full Kitchen Install",  qty: 1, unitPrice: 1800 },
          { item: "Kitchen Units (solid oak)",      qty: 1, unitPrice: 2800 },
          { item: "Worktop — Quartz 4m",            qty: 1, unitPrice: 980 },
          { item: "Appliance Install",              qty: 1, unitPrice: 280 },
          { item: "Plinth & Cornicing",             qty: 1, unitPrice: 190 },
          { item: "VAT (20%)",                      qty: 1, unitPrice: 150 },
        ]},
    ],
    consent: [
  ...
  landscaper: {
    ...
    quotes: [
      { clientName: "Jennifer Park", description: "New Build Garden — Design & Landscape", amount: 5800, status: "sent",
        items: [
          { item: "Design & Planning",          qty: 1, unitPrice: 650 },
          { item: "Labour — Landscaping",        qty: 1, unitPrice: 2200 },
          { item: "Paving (porcelain 40m²)",     qty: 40, unitPrice: 35 },
          { item: "Turf Laying (80m²)",          qty: 1, unitPrice: 480 },
          { item: "Planting & Borders",          qty: 1, unitPrice: 320 },
          { item: "Fencing — 15 Panels",         qty: 15, unitPrice: 10 },
        ]},
      { clientName: "Joel Carter",   description: "Commercial Grounds Maintenance (Annual)", amount: 9600, status: "viewed",
        items: [
          { item: "Lawn Mowing (weekly, 48 visits)",qty: 48, unitPrice: 85 },
          { item: "Hedge Cutting (x4 per year)",    qty: 4, unitPrice: 180 },
          { item: "Seasonal Planting (x2)",          qty: 2, unitPrice: 350 },
          { item: "Litter Collection (weekly)",      qty: 48, unitPrice: 20 },
          { item: "Annual Account Management",       qty: 1, unitPrice: 480 },
        ]},
      { clientName: "Harry Croft",   description: "Full Rear Garden inc. Patio & Lawn", amount: 4200, status: "draft",
        items: [
          { item: "Labour — Full Garden",        qty: 1, unitPrice: 1600 },
          { item: "Patio (Indian sandstone 30m²)",qty: 30, unitPrice: 42 },
          { item: "Turf (60m²)",                  qty: 1, unitPrice: 380 },
          { item: "Raised Beds (x2)",             qty: 2, unitPrice: 220 },
          { item: "Topsoil & Bark Chips",         qty: 1, unitPrice: 260 },
        ]},
    ],
    consent: [
  ...
  cpd: {
    ...
    quotes: [
      { clientName: "Sam Groves",    description: "Group Foundation Course x5 delegates", amount: 1800, status: "sent",
        items: [
          { item: "Foundation Aesthetics Course (per delegate)", qty: 5, unitPrice: 300 },
          { item: "Study Materials & Workbooks",                 qty: 5, unitPrice: 25 },
          { item: "CPD Certificate (per delegate)",             qty: 5, unitPrice: 15 },
          { item: "Venue Hire (1 day)",                         qty: 1, unitPrice: 175 },
        ]},
      { clientName: "Faye Drummond", description: "Online CPD + OSCE Assessment", amount: 620, status: "viewed",
        items: [
          { item: "Online CPD Course Access",  qty: 1, unitPrice: 400 },
          { item: "OSCE Assessment Session",   qty: 1, unitPrice: 150 },
          { item: "CPD Certificate",           qty: 1, unitPrice: 45 },
          { item: "Model Kit",                 qty: 1, unitPrice: 25 },
        ]},
      { clientName: "Kim Baxter",    description: "Annual Team Training Package", amount: 3000, status: "draft",
        items: [
          { item: "Annual Training Subscription (per head)", qty: 8, unitPrice: 250 },
          { item: "In-House Training Day (x2)",              qty: 2, unitPrice: 450 },
          { item: "Compliance Audit & Sign-off",             qty: 1, unitPrice: 300 },
        ]},
    ],
    consent: [
  ...
  health: {
    ...
    quotes: [
      { clientName: "Nina Soloman",  description: "12-Week Nutrition Programme", amount: 360, status: "sent",
        items: [
          { item: "Initial Assessment (90 min)",    qty: 1, unitPrice: 90 },
          { item: "Weekly 1:1 Check-in Sessions",   qty: 11, unitPrice: 20 },
          { item: "Meal Plan & Recipe Pack",        qty: 1, unitPrice: 30 },
          { item: "Blood Panel Interpretation",     qty: 1, unitPrice: 20 },
        ]},
      { clientName: "Karl Stone",    description: "Physio Assessment + 6 Session Plan", amount: 465, status: "viewed",
        items: [
          { item: "Initial Physiotherapy Assessment", qty: 1, unitPrice: 75 },
          { item: "Physiotherapy Sessions",           qty: 6, unitPrice: 65 },
          { item: "Exercise Programme (PDF)",         qty: 1, unitPrice: 0 },
          { item: "Resistance Band Kit",              qty: 1, unitPrice: 0 },
        ]},
      { clientName: "Barry White",   description: "Annual Corporate Massage Contract", amount: 1980, status: "draft",
        items: [
          { item: "Monthly On-site Massage (60 min)", qty: 12, unitPrice: 120 },
          { item: "Therapist Travel Allowance",       qty: 12, unitPrice: 25 },
          { item: "Employee Wellness Report (x2)",    qty: 2, unitPrice: 90 },
        ]},
    ],
    consent: [
  ...
  builder: {
    ...
    quotes: [
      { clientName: "Gavin Booth",  description: "Single Storey Extension — Supply & Build", amount: 28000, status: "sent",
        items: [
          { item: "Labour — Groundworks & Foundations", qty: 1, unitPrice: 6500 },
          { item: "Labour — Brickwork & Blockwork",     qty: 1, unitPrice: 7200 },
          { item: "Roof — Flat Warm Roof",              qty: 1, unitPrice: 4800 },
          { item: "Windows & Bi-fold Doors",            qty: 1, unitPrice: 3800 },
          { item: "Plastering & First-fix",             qty: 1, unitPrice: 2400 },
          { item: "Materials (bricks, blocks, sand)",   qty: 1, unitPrice: 2100 },
          { item: "Skip Hire & Clearance",              qty: 1, unitPrice: 800 },
          { item: "VAT (20%)",                          qty: 1, unitPrice: 400 },
        ]},
      { clientName: "Sarah Doyle",  description: "Porch + Block Paving Driveway", amount: 11000, status: "viewed",
        items: [
          { item: "Labour — Porch Build",               qty: 1, unitPrice: 2800 },
          { item: "Bricks & Mortar",                    qty: 1, unitPrice: 1400 },
          { item: "Roof Tiles & Timbers",               qty: 1, unitPrice: 950 },
          { item: "Labour — Driveway Dig & Block",      qty: 1, unitPrice: 2600 },
          { item: "Block Paving (60m²)",                qty: 60, unitPrice: 28 },
          { item: "Edging, Sand & Sub-base",            qty: 1, unitPrice: 870 },
          { item: "VAT (20%)",                          qty: 1, unitPrice: 700 },
        ]},
      { clientName: "Lisa Moody",   description: "Double Garage Build", amount: 18500, status: "draft",
        items: [
          { item: "Labour — Groundworks",               qty: 1, unitPrice: 3200 },
          { item: "Labour — Brickwork (double garage)", qty: 1, unitPrice: 5800 },
          { item: "Concrete Slab Floor",               qty: 1, unitPrice: 2200 },
          { item: "Roof Trusses & Felt",               qty: 1, unitPrice: 2400 },
          { item: "Roller Garage Door (x2)",            qty: 2, unitPrice: 850 },
          { item: "Electrical — Sockets & Lighting",   qty: 1, unitPrice: 680 },
          { item: "Materials & Consumables",            qty: 1, unitPrice: 2520 },
          { item: "VAT (20%)",                          qty: 1, unitPrice: 800 },
        ]},
    ],
    consent: [
